            ...
            <div className="app-stores-container">
                ...
                <div className="app-stores-btns">
                    <div className="apple-store store">
                        <a href="https://apple.co/3sYMuSs" target="_blank">
                    ...
                    <div className="google-play store">
                        <a href='https://play.google.com/store/apps/details?id=br.net.techcare.app&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1' target="_blank">
